...
public class ItemInterface {
	...
	public static ItemStack getItem(String ident) {
		...
		try {
			...
			String itemClass = pack.substring(0, pack.lastIndexOf('.')) + ".config.ForestryItem";
	...
	// Crafting
	public static Item sturdyMachine;
	public static Item hardenedMachine;
	public static Item craftingMaterial;

	// Rainmaker
	public static Item iodineCapsule;
	...
	// Bees
	public static Item beeQueen;
	public static Item beeDrone;
	public static Item beePrincess;
	...
	public static Item cocoaComb;
	public static Item simmeringComb;
	public static Item stringyComb;
	public static Item frozenComb;
	public static Item drippingComb;
	...
	public static Item masonBackpack; // unused/null
	...
	public static Item masonBackpackT2; // unused/null
