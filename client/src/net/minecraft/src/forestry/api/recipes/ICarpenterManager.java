...
public interface ICarpenterManager extends ICraftingProvider {
	 ...
	 * @param crated an {@link ItemGenericCrate} with a set contained item
	 */
	public void addCrating(ItemGenericCrate crated);
	/**
	 * Add a crating (and corresponding uncrating) recipe
	 * @param toCrate Item to crate
	 * @param crated Crated item
	 */
	public void addCrating(Item toCrate, Item crated);
	/**
	 * Add a crating (and corresponding uncrating) recipe
	 * @param toCrate ItemStack of item to crate
	 * @param crated Crated item
	 */
	 ...
	 * Add a shaped recipe to the carpenter.
	 * @param packagingTime Number of work cycles required to craft the recipe once.
	 * @param liquidId Id of liquid required in tank. Anything other than Block.waterStill.blockId is untested!
	 * @param liquidAmount Amount of liquid required to craft the recipe once. One bucket of water = one unit on the carpenter's tank = 1000.
	 * @param box ItemStack of one item representing the required box (carton, crate) for this recipe. May be null.
	 * @param product Crafting result.
	 * @param materials Materials needed in the crafting matrix. This gets passed directly to {@link ShapedRecipes}. Notation is the same.
	 */
