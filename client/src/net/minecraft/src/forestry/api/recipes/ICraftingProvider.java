...
public interface ICraftingProvider {
	 ...
	 * @return List of the given format where the first array represents inputs and the second outputs. Input and output liquids are returned as itemstacks as well, representing itemID and damage.
	 */
