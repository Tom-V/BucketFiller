...
public interface IBottlerManager extends ICraftingProvider {
	 ...
	 * @param inputAmount Amount of liquid required for a single conversion.
	 * @param can ItemStack representing the cans, capsules and/or cells required
	 * @param bottled ItemStack representing the finished product
	 */
