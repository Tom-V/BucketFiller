...
public interface ICentrifugeManager extends ICraftingProvider {
	 ...
	 * @param chances Array of integers corresponding and matching to {@link produce} providing the chance (0-100) for the ItemStack at the given index to be produced.
	 */
